...
int main(){
  ...
  *r += *(new point(34, 76));  //fonction de translation
  ...
  cout << "périmètre du rectangle : " << r -> perimetre();
  cout << ", surface du rectangle : " << r -> surface() << endl;

  carre * c = new carre(new point(20,20), 10);
  cout << "carré : " << *c << endl;
  *c += *(new point(45,67));
  cout << "carré translaté de x45, y67 : " << *c << endl; 
  cout << "périmètre du carré : " << c -> perimetre();
  cout << ", surface du carré : " << c -> surface() << endl;
